...
from ..modules import SetBlockWrapper, HorizontalPoolingPyramid, PackSequenceWrapper, SeparateFCs, FocalConv2d
...
class GaitPart(BaseModel):
    ...
    def build_network(self, model_cfg):
        ...
        self.FC_1 = nn.Sequential(FocalConv2d(32, 64, 3, 2),
                                nn.LeakyReLU(inplace=True),
                                FocalConv2d(64, 64, 3, 2),
                                nn.LeakyReLU(inplace=True),
                                nn.MaxPool2d(kernel_size=2, stride=2))
        self.FC_2 = nn.Sequential(FocalConv2d(64, 128, 3, 3),
                                nn.LeakyReLU(inplace=True),
                                FocalConv2d(128, 128, 3, 3),
                                nn.LeakyReLU(inplace=True))
        self.FC_1 = SetBlockWrapper(self.FC_1)
        self.FC_2 = SetBlockWrapper(self.FC_2)
    ...
    def forward(self, inputs):
        ...
        # print("sil.shape:{}".format(sils.shape))
